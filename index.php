    ...
    <body>
        <header>
            ...
            <div class="nav-container">
                <nav>
                    ...
                    <a href="findtrainer.html">Find a Trainer</a>
                    <a href="weather.html">Weather</a>
                    <a href="contact.html">Contact Us</a>                    
                </nav>
            </div>
            <div class="user-options">
                <a href="login.html" class="login"><i class="fas fa-sign-in-alt"></i> Login</a>
                <a href="signup.html" class="signup"><i class="fas fa-user-plus"></i> Sign Up</a>
            </div>       
        </header>
        ...
        <section class="section featured-trainers">
            ...
            <div class="trainer-container">
                <div class="trainer-box">
                    ...
                    <a href="#" id="bookbutton" class="Now">Book Now</a>
                </div>
                <div class="trainer-box">
                    <img src="trainer2.jpg" alt="Trainer 2">
                    <h3>Trainer Name 2</h3>
                    <p>Turn fear into fun with your triner, your expert coach for big waves and thrilling sessions</p>
                    <a href="#" id="bookbutton" class="book-Now">Book Now</a>
                </div>
                <div class="trainer-box">
        ...
        <section class="section how-it-works">
            ...
            <div class="call-to-action">
                ...
                <a href="#" id="findTrainerB" class="btn find-trainer">Find your Trainer</a>
            </div>
        </section>
